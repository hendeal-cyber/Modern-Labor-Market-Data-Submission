...
N = 126, R² = 0.5105, adjusted R² = 0.4437, SE: cluster

| Variable | Coef | Std err | p | 95% CI | Approx % effect |
|---|---|---|---|---|---|
| `const` | 10.8661*** | 0.1054 | 0.0 | [10.6596, 11.0727] | — |
| `seniority_rank` | 0.0742*** | 0.0107 | 0.0 | [0.0532, 0.0952] | 7.7% |
| `yrs_exp_min` | 0.0115 | 0.0186 | 0.5376 | [-0.025, 0.048] | 1.16% |
| `yrs_exp_stated` | -0.0915 | 0.1191 | 0.4421 | [-0.325, 0.1419] | -8.75% |
| `degree_required` | -0.0912** | 0.0431 | 0.0343 | [-0.1758, -0.0067] | -8.72% |
| `degree_stem` | 0.1147** | 0.053 | 0.0305 | [0.0108, 0.2186] | 12.15% |
| `skill_cloud` | -0.0321 | 0.0558 | 0.5654 | [-0.1414, 0.0772] | -3.16% |
| `skill_ml_ai` | 0.1876** | 0.0784 | 0.0167 | [0.0339, 0.3414] | 20.64% |
| `remote_eligible` | 0.0448 | 0.043 | 0.2975 | [-0.0394, 0.129] | 4.58% |
| `hourly_original` | -0.1163 | 0.2442 | 0.6341 | [-0.5949, 0.3624] | -10.98% |
| `mandate_state` | 0.0839 | 0.0894 | 0.3484 | [-0.0914, 0.2591] | 8.75% |
| `region_northeast` | 0.2794*** | 0.0966 | 0.0038 | [0.0901, 0.4687] | 32.24% |
| `region_south` | 0.2632*** | 0.0342 | 0.0 | [0.1961, 0.3304] | 30.11% |
| `region_west` | 0.1349** | 0.0547 | 0.0136 | [0.0277, 0.242] | 14.44% |
| `industry_data_center` | 0.1487 | 0.0999 | 0.1366 | [-0.0471, 0.3446] | 16.04% |
| `family_ai_ml` | 0.0066 | 0.0927 | 0.9436 | [-0.1751, 0.1882] | 0.66% |
